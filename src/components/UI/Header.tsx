...
export const Header: React.FC = () => {
  return (
    <header className="w-full h-12 px-6 sm:px-8 flex items-center justify-between z-30 select-none border-b border-black/[0.04] bg-[#FBFBFB]/90 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4 sm:gap-6 font-mono text-[10px] text-[#71717A]">
        <div className="hidden md:flex items-center gap-4">
          <div>
            ...
            <span className="text-[#18181B] font-semibold">9.2</span> (м²·°C)/Вт*
          </div>
          <div className="w-[1px] h-3 bg-[#E4E4E7]" />
          <div>
            <span className="text-[#A1A1AA]">Сборка: </span>
            <span className="text-[#18181B] font-semibold">2–5 дней*</span>
          </div>
        </div>
