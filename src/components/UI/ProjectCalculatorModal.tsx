...
import { X, Check, ArrowRight, Building, Clock, Flame, ShieldAlert } from 'lucide-react';
...
export const ProjectCalculatorModal: React.FC<ProjectCalculatorModalProps> = ({
  ...
  const foundationSavingsPercent = '15–20%';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        className="relative w-full max-w-lg bg-[#FBFBFB] rounded-2xl border border-black/10 p-6 sm:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.12)] text-[#18181B] select-none"
        ...
        {submitted ? (
          <div className="py-12 flex flex-col items-center text-center space-y-3">
            ...
            <h3 className="text-sm font-mono font-semibold uppercase tracking-wider text-[#18181B]">
              Запрос принят инженером
            </h3>
            <p className="text-xs text-[#52525B] max-w-xs">
              Мы сформируем предварительную раскладку панелей под ваши параметры ({area} м², {floors} эт.) и свяжемся с вами.
            </p>
            <button
              onClick={onClose}
